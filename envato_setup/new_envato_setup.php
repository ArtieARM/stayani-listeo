		...
		public function envato_setup_license_activation()
		{
			...
			?>
				<form method="post">
						...
						<tbody>
							...
							<tr class="listeo_settings_text">
								...
								<td>
									...
									<p class="description">We would like to send you updates about our products and services. Please check the box below if you would like to receive these updates.</p>
									<input type="checkbox" name="optin" value="1" checked="checked">
					...
					<input type="hidden" name="listeo_action_verification" value="verification" id="">
			...
			<div class="envato-setup-next-steps">
				<div class="envato-setup-next-steps-first">
					...
					<ul>
						...
						<li class="setup-product"><a class="button button-primary button-large" href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('Finish', 'listeo'); ?></a>
						</li>
						<li class="setup-product"><a class="button button-next button-large" href="https://www.facebook.com/groups/listeousers" target="_blank"><?php esc_html_e('Join Listeo Users FB Group', 'listeo'); ?></a>
						</li>
					</ul>
				</div>
