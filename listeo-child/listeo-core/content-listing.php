<?php
/**
 * Child override: content-listing.php
 * Same strategy as grid version to keep price stable after AJAX.
 */
if ( ! defined('ABSPATH') ) { exit; }

$plugin_template = WP_PLUGIN_DIR . '/listeo-core/templates/content-listing.php';
$parent_template = get_template_directory() . '/content-listing.php';
